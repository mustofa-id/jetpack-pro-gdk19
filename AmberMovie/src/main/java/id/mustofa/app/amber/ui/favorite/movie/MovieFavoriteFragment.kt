...
class MovieFavoriteFragment : BindingFragment<FragmentMovieBinding>(R.layout.fragment_movie) {
    ...
    private fun setupViewModel() {
        ...
        binding?.viewModel = fragmentActivity.obtainViewModel(MovieFavoriteViewModel::class)
