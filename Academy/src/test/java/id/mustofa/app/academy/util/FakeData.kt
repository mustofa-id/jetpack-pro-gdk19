...
object FakeData {
    ...
    fun generateCourses(): List<Course> {
        return listOf(
            Course(
                "a14",
    ...
    fun generateRemoteCourses(): List<CourseResponse> {
        return listOf(
            CourseResponse(
                "a14",
                "Menjadi Android Developer Expert",
    ...
    fun generateModules(courseId: String): List<Module> {
        return listOf(
            Module("${courseId}sm1", courseId, "Modul 0 : Introduction", 0, false),
            Module("${courseId}sm2", courseId, "Modul 1 : Teori 1", 1, false),
            Module("${courseId}sm3", courseId, "Latihan 1", 2, false),
            Module("${courseId}sm4", courseId, "Bedah Kode 1", 3, false),
            Module("${courseId}sm5", courseId, "Modul 2 : Teori 2", 4, false),
            Module("${courseId}sm6", courseId, "Latihan 2", 5, false),
            Module("${courseId}sm7", courseId, "Bedah Kode 2", 6, false)
        )
    }


    fun generateRemoteModules(courseId: String): List<ModuleResponse> {
        return listOf(
            ModuleResponse("${courseId}sm1", courseId, "Modul 0 : Introduction", 0),
            ModuleResponse("${courseId}sm2", courseId, "Modul 1 : Teori 1", 1),
            ModuleResponse("${courseId}sm3", courseId, "Latihan 1", 2),
            ModuleResponse("${courseId}sm4", courseId, "Bedah Kode 1", 3),
            ModuleResponse("${courseId}sm5", courseId, "Modul 2 : Teori 2", 4),
            ModuleResponse("${courseId}sm6", courseId, "Latihan 2", 5),
            ModuleResponse("${courseId}sm7", courseId, "Bedah Kode 2", 6)
        )
    }

    fun generateRemoteContent(moduleId: String) =
